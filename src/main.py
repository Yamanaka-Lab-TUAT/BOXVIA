...
app.layout = dbc.Container([
    ...
    dbc.Row([dbc.Col(html.H5('Import data',
             ...
             dbc.Col([dbc.Badge('?',
                      ...
                      dbc.Tooltip('Import a csv file that input/output data are written as in the sample csv files.',
    ...
    return html.Div([html.H5(filename),
                     dbc.Row([dbc.Col(html.H6(datetime.datetime.fromtimestamp(date)),
                              ...
                              dbc.Col([dbc.Button('Export',
                                      ...
                                      dbc.Tooltip('Download the table data as a Input.csv.',
                                                  target="export_input",
                                                  placement='top',
                                                  ),
                                       ],
                     ...
                     dbc.Row(dbc.Col([dbc.Button('Delete bottom data',
                                      ...
                                      dbc.Tooltip('Delete the bottom data before alignment (Original csv file is not changed).',
                                                  target="delete",
                                                  placement='bottom',
                                                  ),
                                      ],
